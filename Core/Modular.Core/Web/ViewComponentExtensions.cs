...
namespace Modular.Core.Web
{
    public static class ViewComponentExtensions
    {
        public static string GetViewPath(this ViewComponent viewComponent, string viewName = "Default")
        {
            ...
            var viewPath = $"/Modules/Modular.Modules.{viewComponent.GetType().Assembly.GetName().Name.Split('.').Last()}/Views/Shared/Components/{viewComponent.ViewComponentContext.ViewComponentDescriptor.ShortName}/{viewName}.cshtml";
